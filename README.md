...
| **Research Logic** | ![Thinking UI](./assets/screenshots/Research%20Thinking.png) | Visualizing recursive Chain-of-Thought (CoT) and discovery loops. |
| **Model Catalog** | ![Modes Menu](./assets/screenshots/Modes%20and%20models.png) | Access point for 20+ specialized intelligence personas. |
| **Multimodal Terminal** | ![Video Analysis](./assets/screenshots/Video%20analysis%20Backend%20terminal.png) | Backend processing for video transcripts and external links. |
